                      ...
                      <tr key={group.id} className="border-b last:border-b-0">
                        ...
                        <td className="px-3 py-2">
                          <Button
                            ...
                            onClick={() => setCurrentStep(2) || store.setSelectedRequestGroup(group.name)}
                          >
                ...
                {(store.studentRequests || []).map((request, index) => {
                  ...
                  return (
                    <tr key={requestId} className="border-b last:border-b-0">
                      ...
                      <td className="px-3 py-2">
                        <Button size="sm" variant="outline" onClick={() => setCurrentStep(3) || store.setAccessRequestId(requestId)}>
                          Manage
                        </Button>
                      </td>
                    </tr>
