from algopy import ARC4Contract, BoxMapping, String, UInt64
from algopy.arc4 import abimethod


class ConsentApp(ARC4Contract):
    # Persist consent status per key in boxes: 1 = granted, 0 = revoked
    consents: BoxMapping[String, UInt64]
